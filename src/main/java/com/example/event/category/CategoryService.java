...
public class CategoryService {
    ...
    @Autowired
    public CategoryService(CategoryRepository organizerRepository, ItemRepository eventRepository,
            LoggerService loggerService, UserRepository userRepository) {
    ...
    public void deleteOrganizerById(Integer id, Integer userId) {
        ...
        Category o = organizerRepository.findById(id)
                .orElseThrow(() -> new NotFoundException("Không tồn tại danh mục với id " + id));
    ...
    public void updateOrganizerById(Integer id, Integer userId, Category organizer) {
        ...
        Category organizer2 = organizerRepository.findById(id)
                .orElseThrow(() -> new NotFoundException("Không tồn tại danh mục với id: " + id));
